...
/*   Updated: 2022/06/05 11:11:29 by kyuzu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	s = NULL;
// 	printf("=====ft_printf=====\n");
// 	len = ft_printf("%d, %i, %c, %s, %p, %u, %x, %X, %%, Hello world\n",
// 			INT_MAX, INT_MIN, 'A', s, &i, UINT_MAX, INT_MAX, INT_MIN);
// 	printf("len: %d\n", len);
// 	printf("=====printf=====\n");
// 	len = printf("%d, %i, %c, %s, %p, %u, %x, %X, %%, Hello world\n",
// 			INT_MAX, INT_MIN, 'A', s, &i, UINT_MAX, INT_MAX, INT_MIN);
// 	printf("len: %d\n", len);
// 	return (0);
// }
